...
## 3. 收益（2026-09-20 全量，`--timeout 40 -j 6`）

- 新解 9 道（全部 via edge_csp）：**1373 / 1374b / 1375 / 1378 / 0834 / 0631 /
  1110 / 0977 / 0978**，另有 0209 / 0418 / 0952 / 1294 / 1301 等历史 FAIL 噪声带
  内翻正。
- 这 9 道中 1373/1375/1378/0834/0977/0978 在 -j 6 下被 aog OOM（exit -9）拖死，
  单独跑（`AOG_SHAPE_CAP=200000` 或内存不争抢时）全部 SOLVED——OOM 是独立问题
  （aog 形状库无上限，默认 cap=0，见 doc 12 §3.2 #3）。
- 0745 / 0956 本轮 -j 6 下翻负，单跑均 SOLVED → 噪声，非回归。
